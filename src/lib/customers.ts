...
export const DEFAULT_DEMO_CUSTOMERS: Customer[] = [
  {
    ...
    kyc_notes: 'Email: vikram.sharma@example.com | DL: RJ14 20210009876 | Verified by Fleet Admin',
    blacklisted: false,
    total_rentals: 5,
    total_spent: 42500,
  ...
  },
  {
    ...
    gender: 'female',
    address: 'B-12 Collectorate Colony',
    city: 'Jalore',
    state: 'Rajasthan',
    pincode: '343001',
    country: 'India',
    ...
    kyc_status: 'pending',
    kyc_notes: 'DL: RJ14 20220034112 | Uploaded on 18 Sep, pending admin review',
    blacklisted: false,
    total_rentals: 3,
    total_spent: 28000,
    outstanding_balance: 0,
  ...
  },
  {
    ...
    kyc_status: 'verified',
    kyc_verified_at: new Date().toISOString(),
    kyc_notes: 'Email: rajesh.meena@example.com | DL: RJ20 20190088712 | High value VIP client',
    blacklisted: false,
    total_rentals: 8,
    total_spent: 64000,
    outstanding_balance: 0,
  ...
  },
  {
    ...
    kyc_status: 're_upload_requested',
    kyc_notes: 'DL: RJ27 20230012903 | Driving license image blurred. Please upload clear photo.',
    blacklisted: false,
    total_rentals: 2,
    total_spent: 18500,
    outstanding_balance: 0,
  ...
  },
  {
    ...
    kyc_status: 'rejected',
    kyc_notes: 'DL: RJ14 20200055431 | License expired in 2023. Fresh renewal required.',
    blacklisted: false,
    total_rentals: 6,
    total_spent: 51200,
    outstanding_balance: 0,
  ...
  {
    id: 'cust-demo-6',
    profile_id: 'prof-demo-6',
    customer_code: 'CUST-2024-4190',
    date_of_birth: '1998-04-18',
    gender: 'male',
    address: 'Shiv Colony, Bypass Road',
    city: 'Sirohi',
    state: 'Rajasthan',
    pincode: '307001',
    country: 'India',
    emergency_contact_name: 'Amit Joshi',
    emergency_contact_phone: '+91 97830 11223',
    kyc_status: 'pending',
    kyc_notes: 'DL: RJ24 20240091823 | Submitted today, awaiting DL physical copy verification',
    blacklisted: false,
    total_rentals: 1,
    total_spent: 6500,
    outstanding_balance: 0,
