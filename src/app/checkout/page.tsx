...
export const metadata: Metadata = {
  title: 'Secure Checkout — Book Your Rental Car | JSD Jalore Self Drive PVT LTD',
  description: 'Complete your car rental reservation securely with JSD — Jalore Self Drive PVT LTD.',
}
